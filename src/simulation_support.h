...
{
  /* whether the neutron hits the control rod is based upon how far the rod
  has been lowered and the location of the neutron.
  */
...
{
  // release 23e12 neutrons per gram per second.
  double weight;
};
