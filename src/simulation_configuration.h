...
enum config_channel_type_enum
{
  CONFIG_EMPTY = 0,
  CONFIG_FUEL_ASSEMBLY = 1,
  CONFIG_CONTROL_ROD = 2,
  CONFIG_NEUTRON_GENERATOR = 4,
  CONFIG_MODERATOR = 5
};
// Different chemicals that can be in the configuration file
enum config_chemical_type_enum
{
  U235_CONFIG = 0,
  U238_CONFIG = 1,
  Pu239_CONFIG = 2,
...
enum config_moderator_type_enum
{
  WATER_MOD_TYPE_CONFIG,
  DEUTERIUM_MOD_TYPE_CONFIG,
  GRAPHITE_MOD_TYPE_CONFIG,
  NONE_MOD_TYPE_CONFIG
};
